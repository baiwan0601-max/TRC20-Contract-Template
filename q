...
contract MyToken is ITRC20, Ownable {
    ...
    constructor(
        ...
        uint8 decimals_,
        uint256 initialSupply_  // supply expressed in smallest units (i.e., already multiplied by 10**decimals)
    ) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0), "TRC20: mint to zero address");
        _totalSupply += amount;
    ...
    function _burn(address account, uint256 amount) internal {
        require(account != address(0), "TRC20: burn from zero address");
    ...
    function _approve(address owner_, address spender, uint256 amount) internal {
        require(owner_ != address(0), "TRC20: approve from zero");
